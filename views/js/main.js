...
var pizzasDiv = document.getElementById("randomPizzas"); // moved outside of the for loop so that it doesn't get set to pizzaDiv every time the loop executes.
for (var i = 2; i < 100; i++) {
...
// avg time to generate the last 10 frames reduced to an avg of 0.35ms

var items = document.getElementsByClassName('mover'); // Changed to getElementsByClassName, and set outside the function call
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < numberOfPizzas; i++) {
    ...
    elem.style.height = "73.333px"; // made the pizza a square...kinda of squished before
